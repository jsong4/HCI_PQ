document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelector('.next-button').addEventListener('click', () => {
        ...
        if (selectedOption && textValue) {
            localStorage.setItem("selectedPrompt1", selectedOption);
            localStorage.setItem("userAnswer1", textValue);
            window.location.href = "newuser_prompt2.html"; // Redirect to the next page
        } else {
